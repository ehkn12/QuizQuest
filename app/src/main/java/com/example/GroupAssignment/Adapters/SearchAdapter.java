...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder> {
    ...
    public SearchAdapter(ArrayList<Results> breeds, Context context) {
        this.data = breeds;
        mContext = context;
    }
    ...
    public void setText(Results searchAtPosition) {
        switch (searchAtPosition.getRoute()) {
            case "spells/":
                ...
                linearResult.setBackgroundColor(Color.parseColor("#DFACEB"));
                break;
            case "weapons/":
                nameText.setText(searchAtPosition.getName());
                descText.setText(searchAtPosition.getDesc());
                extraText.setText("");
                linearResult.setBackgroundColor(Color.parseColor("#F8EEA7"));
                break;
            default:
                nameText.setText(searchAtPosition.getName());
                descText.setText("");
